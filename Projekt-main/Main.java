...
public class Main {
    public static void main(String[] args) {
        List<Zadania> tasks = new ArrayList<>(); // Tworzy liste zadań bezterminowych
        List<ZadaniaTerminowe> tasks_ter = new ArrayList<>(); // Tworzy liste zadań terminowych
        ...
        while (i){
            ...
            String numer = scan.next(); // Pobieramy co chce zrobić użytkownik
            System.out.println(" ");
            switch (numer){
                case "1": // ODPALENIE MENU ZADAŃ
                    ...
                    while (j){
                        ...
                        System.out.println(" ");
                        System.out.print("Wybrano: ");
                        String numer_1 = scan.next(); // Pobieramy co chce zrobić użytkownik w menu zadań
                        System.out.println(" ");
                        switch (numer_1){
                    ...
                    while (k){
                        ...
                        switch (numer_2){
                            ...
                            case "5":
                                ...
                                break;
                            default:
                                System.out.println(ConsoleColors.RED + "PODANY NUMER AKCJI NIE ISTNIEJE"+ConsoleColors.RESET);
                                break;
                        }
                    }
                    break;
